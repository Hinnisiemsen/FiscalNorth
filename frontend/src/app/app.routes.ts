...
export const routes: Routes = [
    { path: 'login', component: LoginComponent },
    {
        ...
        children: [
            ...
            { path: 'notifications', component: NotificationsComponent, data: { titleKey: 'routes.notifications' } },
            { path: 'account', component: AccountSettingsComponent, data: { titleKey: 'routes.account' } },
            { path: 'accounts', component: AccountListComponent, data: { titleKey: 'routes.accounts' } },
            { path: 'accounts/new', component: AccountCreateComponent, data: { titleKey: 'routes.newAccount' } },
            { path: 'accounts/:id', component: AccountDetailComponent, data: { titleKey: 'routes.account' } },
            { path: 'transactions', component: TransactionListComponent, data: { titleKey: 'routes.transactions' } },
            { path: 'transactions/new', component: TransactionCreateComponent, data: { titleKey: 'routes.newTransaction' } },
            { path: 'transactions/import', component: ImportComponent, data: { titleKey: 'routes.importCsv' } },
            { path: 'contracts', component: ContractListComponent, data: { titleKey: 'routes.contracts' } },
            { path: 'contracts/new', component: ContractCreateComponent, data: { titleKey: 'routes.newContract' } },
            { path: 'budgets', component: BudgetListComponent, data: { titleKey: 'routes.budgets' } },
            { path: 'budgets/new', component: BudgetCreateComponent, data: { titleKey: 'routes.newBudget' } },
            { path: 'bank-sync', component: BankSyncComponent, data: { titleKey: 'routes.bankSync' } },
            { path: 'bank-sync/callback', component: BankSyncCallbackComponent, data: { titleKey: 'routes.bankSyncCallback' } },
            { path: 'categories', component: CategoryListComponent, data: { titleKey: 'routes.categories' } },
            { path: 'categories/new', component: CategoryCreateComponent, data: { titleKey: 'routes.newCategory' } },
        ],
    },
];
